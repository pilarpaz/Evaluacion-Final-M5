   ...
   <header>
    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Listado Chequeos</h2>
                    </div>
      ...
      <table id="tbl" class= "table table-striped table-bordered" style="width:100%">
        ...
        <tr>
          <th>ID Chequeo</th>
          <th>Nombre Chequeo</th>
          <th>Responder Checklist</th>
       
        </tr>
        </thead>
        
        <tbody>
        <c:forEach items="${lchequeos}" var="lc">
        <tr>
          <td><c:out value="${lc.getIdchequeo()}" /></td>
          <td><c:out value="${lc.getNombre()}" /></td>
          <td><a href='<c:out value="${pageContext.request.contextPath}" />/responderchecklist/<c:out value="${idvi}" />/bar/<c:out value="${lc.getIdchequeo()}"/>'>Responder</a>&nbsp;</td>
        </tr>
        </c:forEach>
        </tbody>
      </table>
           
           <a href='<c:out value="${pageContext.request.contextPath}" />/creavisita'>Agregar visita</a>     
            </div>
