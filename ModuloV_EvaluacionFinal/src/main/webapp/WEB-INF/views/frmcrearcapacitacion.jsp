   ...
   <header>
	...
	<section class="contact-section">
		<div class="container">
			...
			<div class="col-12">
				<h2 class="contact-title">Agregar Capacitación</h2>
			</div>
			<div class="border p-3 form">
				<form class="form-contact contact_form" name="frmcrearcap" id="frmcrearcap"
					action='<c:out value="${pageContext.request.contextPath}"/>/procesacrear'
					method="post">
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<input class="form-control w-100" name="fecha" id="fecha"
									type="Date" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Ingrese la fecha de la capacitación'"
									placeholder=" Ingrese la fecha de capacitación">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<input class="form-control valid" type="time" name="hora"
									id="hora" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Ingrese la hora de la capacitación'"
									placeholder="Ingrese la hora de la capacitación">
							</div>
						</div>
						<div class="col-12">
							<div class="form-group">
								<input class="form-control valid" name="lugar" id="lugar"
									type="text" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Ingrese el lugar de la capacitación'"
						...
						<div class="col-sm-6">
							<div class="form-group">
								<input class="form-control valid" name="duracion" id="duracion"
									type="text" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Ingrese la duración de la capacitación'"
						...
						<div class="col-12">
							<div class="form-group">
								<input class="form-control valid" name="rut" id="rut"
									type="text" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Ingrese el rut del cliente'"
						...
						<!--  <div class="col-12">
							<div class="form-group">
								<select class=" form-select form-control valid " name="runcli"
									id="runcli">
									<option selected>Seleccione el cliente asociado a la capacitación</option>
									<c:forEach items="${lclientes}" var="l">
										<option value='<c:out value='${l.getRun_cliente()}' />'><c:out
												value="${l.getNombres()}" />
											<c:out value="${l.getApellidos()}" /></option>
									</c:forEach>
								</select>
							</div>
						</div>-->
