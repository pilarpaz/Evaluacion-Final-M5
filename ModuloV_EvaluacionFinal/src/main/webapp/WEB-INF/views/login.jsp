   ...
   <header>
    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Inicio Sesión</h2>
                    </div>
    <%
		String error = (String) request.getAttribute("error");
		if (error != null && error.equals("true")) {
			out.println("<h4 style=\"color:red\">Credenciales de acceso no son válidas. Por favor intente nuevamente!!</h4>");
		}
	%>
	<form name='loginForm' action="<c:url value='login' />" method='POST'>
                      <div class="col-sm-6">
                         <div class="form-group">
                             <input class="form-control w-100" name="username" id="username"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'ingrese usuario'" placeholder=" Ingrese usuario">
                         </div>
                      </div>
                      
                    <div class="col-sm-6">
                        <div class="form-group">
                             <input class="form-control w-100" type="password" name="password" id="password"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'ingrese contraseña'" placeholder=" Ingrese contraseña">
                        </div>
                  </div>
                  
                  <div class="form-group mt-3">
                    <button type="submit" class="button button-contactForm boxed-btn">Ingresar</button>
                  </div>
