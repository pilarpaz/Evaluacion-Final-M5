    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="border p-3 form">
                         <form class="form-contact contact_form" action='<c:out value="${pageContext.request.contextPath}"/>/procesacontacto' method="post"  >
                            <div class="row">
                         
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="nombre" id="nombre" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ingrese su nombre'" placeholder="Ingrese su nombre">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="correo" id="correo" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ingrese su correo electrónico'" placeholder="Ingrese su correo electrónico" >
                                    </div>
                                </div>
							 ...
							 <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="telefono" id="telefono" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ingrese su teléfono'" placeholder="Ingrese su teléfono">
                                    </div>
                             	</div>
                             	
                             	<div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="mensaje" id="mensaje" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ingrese su mensaje'" placeholder="Ingrese su mensaje" ></textarea>
                                    </div>
                             	</div>
