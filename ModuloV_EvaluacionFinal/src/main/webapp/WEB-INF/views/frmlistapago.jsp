   ...
   <header>
    ...
    <section class="contact-section">
      ...
      <table id="tbl" class= "table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
        <c:forEach items="${lpago}" var="l">
        <tr>
          <td><c:out value="${l.getIdpago()}" /></td>
          <td><c:out value="${l.getFechapago()}" /></td>
          <td><c:out value="${l.getMonto()}" /></td>
          <td><c:out value="${l.getMes()}" /></td>
          <td><c:out value="${l.getAnio()}" /></td>
          <td><c:out value="${l.getRuncliente()}" /></td>
        </tr>
        </c:forEach>
        </tbody>
      </table>
