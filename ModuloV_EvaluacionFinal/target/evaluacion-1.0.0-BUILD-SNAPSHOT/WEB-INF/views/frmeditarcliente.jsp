   ...
   <header>
    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Edición Usuario tipo Cliente</h2>
                    </div>
                    <div class="border p-3 form">
                         <form name="frmcrearid" id="frmcrearid" class="form-contact contact_form" action='<c:out value="${pageContext.request.contextPath}"/>/procesareditarcli' method="post"  >
        					 	<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100' name='run' id='run' value= '<c:out value="${cliente.getRun_cliente()}" ></c:out>' onfocus='this.placeholder = ' onblur='this.placeholder = "ingrese el run del cliente"' placeholder='ingrese el run del cliente'>
                                    </div>
             					</div>
								<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100' name='nombres' id='nombres' value= '<c:out value="${cliente.getNombres()}" ></c:out>' onfocus='this.placeholder = ' onblur='this.placeholder = "ingrese los nombres del cliente"' placeholder='ingrese los nombres del  cliente'>
                                    </div>
             					 </div>
           						 <div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100' name='apellidos' id='apellidos' value= '<c:out value="${cliente.getApellidos()}" ></c:out>' onfocus='this.placeholder = ' onblur='this.placeholder = "ingrese los apellidos del cliente"' placeholder='ingrese los apellidos del  cliente'>
                                    </div>
              					</div>
								<div class='col-12'>
                                   <div class='form-group'>
                                      <input class='form-control w-100' name='telefono' id='telefono' value= '<c:out value="${cliente.getTelefono()}" ></c:out>' onfocus='this.placeholder = ' onblur='this.placeholder = "ingrese el numero telefono cliente"' placeholder='ingrese el numero telefono cliente'>
                                   </div>
              					</div>
           						 <div class='col-12'>
                                    <div class='form-group'>
                                       <select class=' form-select form-control valid ' name='afps' id='afps'>
                                      	<option selected><c:out value="${cliente.getAfp()}" ></c:out></option>
              					 ...
              					 <div class='col-12'>
                                    <div class='form-group'>
                                      <select class=' form-select form-control valid ' name='salud' id='salud'>
                                     	<option selected><c:out value="${cliente.getSistema_salud()}" ></c:out></option>
								...
								<div class='col-12'>
                                   <div class='form-group'>
                                      <input class='form-control w-100' name='direccion' id='direccion' value= '<c:out value="${cliente.getDireccion()}" ></c:out>' onfocus='this.placeholder = ' onblur='this.placeholder = "ingrese la direccion del  cliente"' placeholder='ingrese la direccion del  cliente'>
                                   </div>
            					</div>
            					
								<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100' name='comuna' id='comuna' value= '<c:out value="${cliente.getComuna()}" ></c:out>' onfocus='this.placeholder = ' onblur='this.placeholder ="ingrese la comuna del cliente"' placeholder='ingrese la comuna del cliente'>
                                    </div>
              					</div>
           						<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100' name='edad' id='edad' value= '<c:out value="${cliente.getEdad()}" ></c:out>' onfocus='this.placeholder = ' onblur='this.placeholder = "ingrese la edad del cliente"' placeholder='ingrese la edad del cliente'>
                                    </div>
              					</div>
              					<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100'  name='run_usuario' id='run_usuario' value= '<c:out value="${cliente.getRunusuario()}" ></c:out>' readonly>
                                    </div>
              					</div>
    ...
    <!-- JS here -->
        ...
        <!-- Jquery editar cliente-->
         <script src="${pageContext.request.contextPath}/resources/JS/validacliente.js"></script>
