   ...
   <header>
    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Edición Usuario tipo Profesional</h2>
                    </div>
                    <div class="border p-3 form">
                         <form name="frmcrearid" id="frmcrearid" class="form-contact contact_form" action='<c:out value="${pageContext.request.contextPath}"/>/procesareditarpro' method="post"  >
        					<div class='col-12'>
                                   <div class='form-group'>
                                       <input class='form-control w-100' name='run_pro' id='run_pro' value= '<c:out value="${profesional.getRunprofesional()}" ></c:out>'  onfocus="this.placeholder = ''" onblur="this.placeholder = 'ingrese el run del profesional'" placeholder=" ingrese el run del profesional" readonly>
                                    </div>
             				</div>
							<div class='col-12'>
                                    <div class='form-group'>
                                       <input class='form-control w-100' name='nombre_pro' id='nombre_pro' value= '<c:out value="${profesional.getNombre_pro()}" ></c:out>' onfocus="this.placeholder = ''" onblur="this.placeholder = 'ingrese el nombre del profesional'" placeholder=" ingrese el nombre del profesional">
                                    </div>
              				</div>
            				<div class='col-12'>
                                    <div class='form-group'>
                                       <input class='form-control w-100' name='apellido_pro' id='apellido_pro' value= '<c:out value="${profesional.getApellido_pro()}" ></c:out>' onfocus="this.placeholder = ''" onblur="this.placeholder = 'ingrese el apellido del profesional'" placeholder=" ingrese el apellido del profesional">
                                    </div>
             				 </div>
							<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100' name='telefono_pro' id='telefono_pro' value= '<c:out value="${profesional.getTelefono_pro()}" ></c:out>' onfocus="this.placeholder = ''" onblur="this.placeholder = 'ingrese el telefono del profesional'" placeholder=" ingrese el telefono del profesional">
                                    </div>
              				</div>
							<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100' name='titulo' id='titulo' value= '<c:out value="${profesional.getTitulo()}" ></c:out>' onfocus="this.placeholder = ''"  onblur="this.placeholder = 'ingrese el titulo del profesional'" placeholder=" ingrese el titulo del profesional">
                                    </div>
              				</div>
							<div class='col-12'>
                                    <div class='form-group'>
                                      <input class='form-control w-100'  name='proyecto' id='proyecto' value= '<c:out value="${profesional.getProyecto()}" ></c:out>' onfocus="this.placeholder = ''" onblur="this.placeholder = 'ingrese el proyecto del profesional'" placeholder=" ingrese el proyecto del profesional">
                                    </div>
              				</div>
              				<div class='col-12'>
                                    <div class='form-group'>
    ...
    <!-- JS here -->
        ...
        <!-- Jquery crear usuario-->
         <script src="${pageContext.request.contextPath}/resources/JS/validaprofesional.js"></script>
