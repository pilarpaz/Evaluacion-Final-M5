   ...
   <header>
    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Acceder como</h2>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <a href="<%=request.getContextPath()%>/iniciocli"><img src="${pageContext.request.contextPath}/resources/assets/img/team/cliente.jpg" alt=""></a>
                            </div>
                            <div class="team-caption">
                                <span>Cliente</span>
                                <h3>Acceder como Cliente</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                               <a href="<%=request.getContextPath()%>/inicioadmi"><img src="${pageContext.request.contextPath}/resources/assets/img/team/administrativo.png" alt=""></a>
                            </div>
                            <div class="team-caption">
                                <span>Administrativo</span>
                                <h3>Acceder como Administrativo</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <a href="<%=request.getContextPath()%>/iniciopro"><img src="${pageContext.request.contextPath}/resources/assets/img/team/team1.png" alt=""></a>
                            </div>
                            <div class="team-caption">
                                <span>Profesional</span>
                                <h3>Acceder como Profesional</h3>
                            </div>
                        </div>
                    </div>
			</div>
