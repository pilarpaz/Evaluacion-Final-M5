   ...
   <header>
    ...
    <section class="contact-section">
            <div class="container">    
                    ...
                    <div class="col-12">
                        <h2 class="contact-title">Responder Checklist</h2>
                    </div>
                    <div class="border p-3 form">
                         <form class="form-contact contact_form" action='<c:out value="${pageContext.request.contextPath}"/>/procesacheck' method="post"  >
                            <div class="row">
                                
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="idvisita" id="idvisita" type="text" value='<c:out value='${idvi}' />' readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="idchequeo" id="idchequeo" type="text" value='<c:out value='${idcheck}' />' readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                    <select class=" form-select form-control valid "  name="estado" id="estado" >
                                      <option selected>Seleccione el tipo de estado</option>
                                      <option value="1">Cumple</option>
                                      <option value="2">No cumple</option>
                                      <option value="3">Cumple con observaciones</option>
                                    </select>                                    
                                </div>
                                </div>
								</div>
					...
					<a href='<c:out value="${pageContext.request.contextPath}" />/agregarchequeo/<c:out value='${idvi}' />'>Agregar Chequeo</a>
                    </div>
