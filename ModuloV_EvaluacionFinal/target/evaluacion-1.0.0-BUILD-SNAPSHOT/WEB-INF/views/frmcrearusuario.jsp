                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                       <input class="form-control w-100" name="txtnombre" id="txtnombre"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'ingrese nombre del usuario'" placeholder=" Ingrese nombre del usuario">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="txtfecha" id="txtfecha" type="Date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ingrese su fecha de nacimiento'" placeholder="Ingrese su fecha de nacimiento">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                    <select class=" form-select form-control valid "  name="tipousuario" id="tipousuario" onchange="cargartipo();">
                                ...
                                <div class="col-12"><div id="contenido">
